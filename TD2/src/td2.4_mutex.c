...
static atomic_uint ticket, turn = 0;
...
int main()
{
  ...
  pthread_t a,b;
  pthread_t mutex_lock, mutex_unlock;
  pthread_create(&mutex_lock, NULL, my_mutex_lock, NULL );
  pthread_create(&mutex_unlock, NULL, my_mutex_unlock, NULL );
